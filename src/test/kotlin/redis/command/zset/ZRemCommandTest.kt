...
class ZRemCommandTest {
    ...
    private lateinit var command: ZRemCommand
    ...
    fun `존재하는 멤버를 삭제하면 1을 반환한다`() {
        ...
        val args = listOf(
            RESPValue.BulkString("ZREM".toByteArray()),
    ...
    fun `모든 멤버를 삭제하면 키도 삭제된다`() {
        ...
        assertThat(store.containsKey("myzset")).isFalse()
    }
    ...
    @Test
    fun `String 타입의 키에 zrem하면 WrongTypeException을 던진다`() {
